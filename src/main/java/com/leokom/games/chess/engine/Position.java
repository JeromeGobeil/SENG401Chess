...
public class Position implements GameState< Move, Position > {
	...
	{
		new PositionSnapshot(pieces, hasKingMoved, hasARookMoved,
				hasHRookMoved, hasCastlingExecuted,  sideToMove, movedSide,
				 gameResult,  terminal, winningSide,  waitingForAcceptDraw,  rules);
	}
	
	//Restore the position to a previous state
	public void setState(Map<String,Piece> pieces, Set< Side > hasKingMoved, Set< Side > hasARookMoved,
	...
	public Position move( Move move ) {
		...
		//Create a snapshot of this position before making a move
		createSnapshot();
